...
class FormService implements FormServiceInterface
{
     ...
     * {@inheritdoc}
     *
     * @see \Module\Service\FormServiceInterface::createForm()
     */
    public function createForm($moduleDir, $moduleName)
    {
        ...
        $namespaceName = ucfirst($moduleName) . '\Form';
        ...
        $code->addUse(ucfirst($moduleName) . '\Entity\Entity');
        
        $code->addUse(ucfirst($moduleName) . '\Hydrator\Hydrator');
        ...
        file_put_contents($moduleDir . '/Form/Form.php', $file->generate());
        
        // create factory
        $factory = new ClassGenerator();
        
        $factory->setNamespaceName($this->moduleName . '\Form\Factory');
        
        $factory->setName('FormFactory');
        
        $factory->addUse('Zend\ServiceManager\ServiceLocatorInterface');
        
        $factory->addUse($this->moduleName . '\Form\Form');
        ...
        file_put_contents($moduleDir . '/Form/Factory/FormFactory.php', $file->generate());
    }
