...
class ServiceService implements ServiceServiceInterface
{
    ...
    public function createService($moduleDir, $moduleName)
    {
        ...
        // name space
        $namespaceName = ucfirst($this->moduleName) . '\Service';
        ...
        $this->code->addUse($this->moduleName . '\Entity\Entity');
        
        $this->code->addUse($this->moduleName . '\Mapper\MysqlMapperInterface');
        ...
        file_put_contents($this->moduleDir . '/Service/Service.php', $file->generate());
    ...
    protected function createSave()
    {
        ...
        $dockBlock->setLongDescription('@see \\' . $this->moduleName . '\Service\ServiceInterface::save()');
    ...
    protected function createGet()
    {
        ...
        $dockBlock->setLongDescription('@see \\' . $this->moduleName . '\Service\ServiceInterface::get()');
    ...
    protected function createGetAll()
    {
        ...
        $dockBlock->setLongDescription('@see \\' . $this->moduleName . '\Service\ServiceInterface::getAll()');
    ...
    protected function createDelete()
    {
        ...
        $dockBlock->setLongDescription('@see \\' . $this->moduleName . '\Service\ServiceInterface::delete()');
    ...
    protected function createInterface()
    {
        ...
        $code->addUse(ucfirst($this->moduleName) . '\Entity\Entity');
        ...
        file_put_contents($this->moduleDir . '/Service/ServiceInterface.php', $file->generate());
    ...
    {
        $namespaceName = ucfirst($this->moduleName) . '\Service\Factory';
        
        $dockBlock = new DocBlockGenerator();
        
        $dockBlock->setTags(array(
            new ParamTag('serviceLocator', 'ServiceLocatorInterface'),
            new ReturnTag('\\' . $this->moduleName . '\Service\Service')
        ));
        ...
        $code->addUse($this->moduleName . '\Service\Service');
        
        $serviceLocator = new ParameterGenerator('serviceLocator', 'ServiceLocatorInterface');
        
        $body = '$mapper = $serviceLocator->get(\'' . $this->moduleName . '\Mapper\MysqlMapperInterface\');
...
return new Service($mapper);';
        ...
        file_put_contents($this->moduleDir . '/Service/Factory/ServiceFactory.php', $file->generate());
