...
class MapperService implements MapperServiceInterface
{
    ...
    public function createMapper($moduleDir, $moduleName)
    {
        ...
        // name space
        $namespaceName = ucfirst($this->moduleName) . '\Mapper';
        ...
        $this->code->addUse('Application\Mapper\AbstractMysqlMapper');
        
        $this->code->addUse(ucfirst($this->moduleName) . '\Entity\Entity');
        ...
        file_put_contents($this->moduleDir . '/Mapper/MysqlMapper.php', $file->generate());
...
parent::__construct($readAdapter, $writeAdapter);';
    ...
    protected function createGetAll()
    {
        ...
        $dockBlock->setLongDescription('@see \\' . $this->moduleName . '\Mapper\MysqlMapperInterface::getAll()');
...
';
    ...
    protected function createGet()
    {
        ...
        $dockBlock->setLongDescription('@see \\' . $this->moduleName . '\Mapper\MysqlMapperInterface::get()');
...
';
    ...
    protected function createSave()
    {
        ...
        $dockBlock->setLongDescription('@see \\' . $this->moduleName . '\Mapper\MysqlMapperInterface::save()');
...
return $this->get($entity->get' . $this->moduleName . 'Id());';
    ...
    protected function createDelete()
    {
        ...
        $dockBlock->setLongDescription('@see \\' . $this->moduleName . '\Mapper\MysqlMapperInterface::delete()');
...
return $this->deleteRow();';
    ...
    protected function createInterface()
    {
        ...
        file_put_contents($this->moduleDir . '/Mapper/MysqlMapperInterface.php', $file->generate());
    ...
    {
        $namespaceName = ucfirst($this->moduleName) . '\Mapper\Factory';
        ...
        $code->addUse($this->moduleName . '\Hydrator\Hydrator');
        
        $code->addUse($this->moduleName . '\Entity\Entity');
        
        $code->addUse($this->moduleName . '\Mapper\MysqlMapper');
...
';
        ...
        file_put_contents($this->moduleDir . '/Mapper/Factory/MysqlMapperFactory.php', $file->generate());
